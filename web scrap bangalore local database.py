...
url = "https://www.99acres.com/search/property/buy/bangalore-all?city=20&preference=S&area_unit=1&res_com=R"
...
for g in range (100):
    ...
    for a in property_name_list:
        ...
        data["Property City"].append("Bangalore")
    ...
    for p in Property_name_extra:
        ...
        data_extra["Property city extra"].append("Bangalore")
...
client = pymongo.MongoClient("mongodb://localhost:27017") # Have done through local host as network one wasn't working 
print(client)
